...
public class Probas { //calcule la proba de gagner si l'attaquant a k d�s au total sur son territoire de d�part  et l'adversaire n d�s (on rappelle qu'en cas d'�galit� lors du tirage, le defenseur gagne)
	int k ;//d�s de l'attaquant
	int n; //du d�fenseur
	float proba;
	Probas(int k, int n){
		float proba = 1/4;
