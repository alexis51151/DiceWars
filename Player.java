...
public class Player {
	...
	double intermediate_value(double alpha) { //valeur intermédiaire servant à calculer la valeur d'une situation pour un joueur. Alpha permet de choisir quel nombre de dés est l'optimum à réaliser (avant le gain de tour... donc pas maximum)
