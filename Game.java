...
//--------------------------------Make the Board the same each time : for tests-----------------------------------------
		Game.plateau = new Board(6,4,2,30,6);
...
//-------------------------------------------------------------------------------------------------------		
		...
		Text idjoueurtext = new Text(2*xinit+75,yinit-10,"Tour du joueur n°"+this.idjoueur + "(" + liste_colors_string[this.idjoueur] +")");
	...
	public class TaskDisplay extends Task{
		...
		protected Object call() throws Exception {
			...
			System.out.println(Probas.matToString(Probas.ProbaMatrix(8)));
...
//						}
					    ...
					    // IA utilisant l'algoritme inspiré par Monte Carlo
