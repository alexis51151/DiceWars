	...
	public class Actions_graded_evolved {  //renvoie une liste des actions possibles, avec les notes (gr�ce � nextsituations)
		 ArrayList<int[]> actions;
		 ArrayList<Double> grades;
		 ArrayList<Double> transitions;
		 Player gamer;
		 Player ennemy;
		 ...
		 Actions_graded_evolved(Nextsituationsevolved nextsituations, Player gamer2){ //note la meilleure action face � l'adversaire gamer2
			 ...
			 while (it_actions.hasNext()) {
				 ...
				 if (action[4] == 1) {
					...
					//System.out.println(gamer2.id);
					note = nextsituations.gamer.value(gamer2, 4, territories1, territories2);  //on utilise choicetree pour faire intervenir toutes les probas dans la note 
			 ...
			 this.gamer = gamer;
			 this.ennemy = gamer2;
			 this.transitions = transition_chances;
		 }
